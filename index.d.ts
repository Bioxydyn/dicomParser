declare module 'dicom-parser' {
  ...
  export interface Element {
    ...
    // Byte offset of the start of this element/item in the source byte array.
    tagStartOffset: number;
    // Byte offset immediately after this element/item ends. Useful for cutting
    // tags out of the original byte stream for de-identification.
    tagEndOffset?: number;
  ...
  export interface DataSet {
    ...
    /**
     * Finds the element for tag and returns an unsigned int 64 (as a BigInt) if it exists and has data. Use this function for VR type UV.
     */
    uint64: (tag: string, index?: number) => bigint | undefined;
