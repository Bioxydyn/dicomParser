...
export default function readPart10Header (byteArray, options = {}) {
  ...
  function readTheHeader() {
    ...
    while (littleEndianByteStream.position < littleEndianByteStream.byteArray.length) {
      ...
      // Match parseDicomDataSet: every element should carry tagEndOffset so consumers
      // (e.g. de-identifiers that exsect tag bytes) work uniformly across file meta and dataset.
      element.tagEndOffset = littleEndianByteStream.position;
